...
public enum OGlobalConfiguration {
  ...
  @Deprecated DISK_WRITE_CACHE_PAGES_PER_SECOND("storage.diskCache.writeCachePagesPerSecond",
  ...
  @Deprecated DISK_WRITE_CACHE_FLUSH_WRITE_INACTIVITY_INTERVAL("storage.diskCache.writeCacheFlushInactivityInterval",
  ...
  DISC_CACHE_FREE_SPACE_CHECK_INTERVAL_IN_PAGES("storage.diskCache.diskFreeSpaceCheckIntervalInPages",
      "The interval (how many new pages should be added before free space will be checked), after which the storage periodically "
          + "checks whether the amount of free disk space is enough to work in write mode", Integer.class, 480),
  ...
  @Deprecated WAL_FULL_CHECKPOINT_SHUTDOWN_TIMEOUT("storage.wal.fullCheckpointShutdownTimeout",
  ...
  DISTRIBUTED_CONFLICT_RESOLVER_REPAIRER_CHECK_EVERY("distributed.conflictResolverRepairerCheckEvery",
      "Time (in ms) when the conflict resolver auto-repairer checks for records/cluster to repair", Long.class, 5000l, true),
